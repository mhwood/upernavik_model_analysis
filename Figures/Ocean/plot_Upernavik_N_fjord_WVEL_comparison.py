...
def plot_transects(project_dir, year,
    ...
    output_file = os.path.join(project_dir, 'Figures', 'Ocean', 'Upernavik N Wvel Transect Comparison.png')
...
# depth = griddata(reprojected_points, Depth.ravel(),
#                  np.column_stack((transect_x, transect_y)), method='nearest')
#
# plt.plot(transect_x, transect_y, 'g-', linewidth=2)
# plt.scatter(reprojected_points[:,0], reprojected_points[:,1], c='b', s=1)


model_depth_control, model_distance_control, annual_model_grids_control = \
    read_model_transect_data(project_dir, 'baseline', years, 11, 'Wvel')

model_depth_melange, model_distance_melange, annual_model_grids_melange = \
    read_model_transect_data(project_dir, 'baseline_melange', years, 11, 'Wvel')

model_depth_iceplume, model_distance_iceplume, annual_model_grids_iceplume = \
    read_model_transect_data(project_dir, 'baseline_iceplume', years, 11, 'Wvel')

model_depth_melange_iceplume, model_distance_melange_iceplume, annual_model_grids_melange_iceplume = \
    read_model_transect_data(project_dir, 'baseline_melange_iceplume', years, 11, 'Wvel')


# plt.imshow(annual_model_grids_iceplume[2016])
# plt.show()

plot_transects(project_dir, years,
               distance, surface, ice_polygon, bed_polygon,
               model_depth_control, model_distance_control, annual_model_grids_control,
               model_depth_melange, model_distance_melange, annual_model_grids_melange,
               model_depth_iceplume, model_distance_iceplume, annual_model_grids_iceplume,
